...
/**
 * Geo inline (sin importar archivos locales): en Vercel Edge, un middleware en varios chunks
 * puede generar `__dirname` en el runtime y romper con 500. Mantén en sync con ./geo-from-request.ts.
 */
...
async function getGeoFromRequest(
...
/**
 * Redirección por país (GEO_REDIRECT_MAP en env).
 */
